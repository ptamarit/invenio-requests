...
class RequestEventsService(RecordService):
    ...
    def update(self, identity, id_, data, revision_id=None, uow=None, expand=False):
        ...
        # TODO: This is clearly not the correct way of expanding files information here.
        FilesDumperExt().dump(event, data) # This might not be necessary.
    ...
    def delete(self, identity, id_, revision_id=None, uow=None):
        ...
        # ~~RequestCommentFileCleanupComponent could also be a service method.~~
        # ~~In RequestCommentFileCleanupComponent, I should use event which is the original one.~~
