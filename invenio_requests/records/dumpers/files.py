...
class FilesDumperExt(SearchDumperExt):
    ...
    def dump(self, request_event, data):
        ...
        request_files_by_file_id = {request_file.file.file_id: request_file for request_file in request_files}
        ...
        for payload_file in payload_files:
            ...
            if file_details is not None:
                ...
                payload_file["original_filename"] = file_details.model.data["original_filename"]
